...
class NocolDoorEnvV0(mujoco_env.MujocoEnv, utils.EzPickle):
    def __init__(self):
        ...
        mujoco_env.MujocoEnv.__init__(self, curr_dir+'/assets/DAPG_door_nocol.xml', 5)
        ...
        print("door latch did", self.door_latch_did)
